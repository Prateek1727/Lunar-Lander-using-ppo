...
def train_ppo(num_episodes=NUM_EPISODES_DEFAULT, filename="best_policy_2203.npy"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, default="best_policy_2203.npy", help="Filename to save/load the model.")
